...
function encode_sample(buf::ReplayBuffer, idxes; stack=1)
    ...
    stacksize = length(inpsize) < 3 ? (inpsize[1]*stack, inpsize[2:end]...) : (inpsize[1], inpsize[2], inpsize[3]*4, inpsize[4:end]...)
...
function sample(buf::ReplayBuffer, batchsize; stack=1)
